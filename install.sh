...
## SYSTEM UTILITIES 
brew cask install 1password postman disk-inventory-x moom flux unetbootin airflow istat-menus caffeine cyberduck rescuetime the-unarchiver dropbox --appdir=/Applications
